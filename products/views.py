    ...
    def post(self, request):
        ...
        try:
            ...
            session = stripe.checkout.Session.create(
                ...
                mode='payment',
                success_url='https://ecomerce.netlify.app/checkout-complete.html?session_id={CHECKOUT_SESSION_ID}',
                cancel_url='https://ecomerce.netlify.app/checkout-payment.html',
            )
